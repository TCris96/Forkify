...
class RecipeView extends View {
    ...
    addHandlerUpdateServings(handler) {
      $(this._parentElement).on('click', function(event) {
    ...
    addHandlerDeleteRecipe(handler) {
      $(this._parentElement).on('click', function(event) {
        const btn = event.target.closest('[data-name="btn--delete"]');
    ...
    _generateRecipeIngredient(ingredient) {
        return `
    ...
    _generateMarkup() {
        ...
        <div class="recipe__details">
          ...
          <button class="btn--round ${this._data.key ? '' : 'hidden'}" data-name="btn--delete">
            <svg class="">
        ...
        <div class="recipe__ingredients">
          ...
          ${this._data.ingredients.map(this._generateRecipeIngredient).join('')}
